    ...
    public List<ChessboardPoint> canMoveTo() {
        ...
        for (int i = 1; i < 8; i++) {
            if (x + i >= 0 && x + i <= 7 && y + i >= 0 && y + i <= 7) {
                if (getComponentColor(chessboard[x + i][y + i].toString().charAt(0)) == ChessColor.NONE) {
                    moveTo.add(new ChessboardPoint(x + i, y + i));
                } else if (getComponentColor(chessboard[x + i][y + i].toString().charAt(0)) != chessColor) {
                    moveTo.add(new ChessboardPoint(x + i, y + i));
                    break;
                }else
                    break;
