...
public class KingChessComponent extends ChessComponent {
    ...
    public KingChessComponent(int x, int y, ChessComponent[][] chessboard) {
        this.x = x;
        this.y = y;
    ...
    public List<ChessboardPoint> canMoveTo() {
        ...
        if (offset1(x, y, 1, 0) != null) {
            result1.add(offset1(x, y, 1, 0));
        }
        if (offset1(x, y, -1, 0) != null) {
            result1.add(offset1(x, y, -1, 0));
        }
        if (offset1(x, y, 0, 1) != null) {
            result1.add(offset1(x, y, 0, 1));
        }
        if (offset1(x, y, 0, -1) != null) {
            result1.add(offset1(x, y, 0, -1));
        }
        if (offset1(x, y, 1, 1) != null) {
            result1.add(offset1(x, y, 1, 1));
        }
        if (offset1(x, y, -1, -1) != null) {
            result1.add(offset1(x, y, -1, -1));
        }
