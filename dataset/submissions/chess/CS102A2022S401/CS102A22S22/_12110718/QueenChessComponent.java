...
class QueenChessComponent extends ChessComponent {
    ...
    public List<ChessboardPoint> canMoveTo() {
        ...
        for (int i = 1; ; i++) {
            if (getSource().getX() - i >= 0 && getSource().getY() + i < 8 && getConcreteChessGame().getChess(getSource().getX() - i, getSource().getY() + i).name == '_') {
                points.add(new ChessboardPoint(getSource().getX() - i, getSource().getY() + i));
            } else if (getSource().getX() - i >= 0 && getSource().getY() + i < 8 && getConcreteChessGame().getChess(getSource().getX() - i, getSource().getY() + i).getChessColor() != getChessColor()) {
                points.add(new ChessboardPoint(getSource().getX() - i, getSource().getY() + i));
                break;
            } else {
                break;
        ...
        for (int i = 1; ; i++) {
            if (getSource().getX() - i >= 0 && getSource().getY() - i >= 0 && getConcreteChessGame().getChess(getSource().getX() - i, getSource().getY() - i).name == '_') {
                points.add(new ChessboardPoint(getSource().getX() - i, getSource().getY() - i));
            } else if (getSource().getX() - i >= 0 && getSource().getY() - i >= 0 && getConcreteChessGame().getChess(getSource().getX() - i, getSource().getY() - i).getChessColor() != getChessColor()) {
                points.add(new ChessboardPoint(getSource().getX() - i, getSource().getY() - i));
                break;
            } else {
                break;
        ...
        for (int i = 1; ; i++) {
            if (getSource().getX() + i < 8 && getSource().getY() - i >= 0 && getConcreteChessGame().getChess(getSource().getX() + i, getSource().getY() - i).name == '_') {
                points.add(new ChessboardPoint(getSource().getX() + i, getSource().getY() - i));
            } else if (getSource().getX() + i < 8 && getSource().getY() - i >= 0 && getConcreteChessGame().getChess(getSource().getX() + i, getSource().getY() - i).getChessColor() != getChessColor()) {
                points.add(new ChessboardPoint(getSource().getX() + i, getSource().getY() - i));
                break;
            } else {
                break;
        ...
        for (int i = 1; ; i++) {
            if (getSource().getX() + i < 8 && getSource().getY() + i < 8 && getConcreteChessGame().getChess(getSource().getX() + i, getSource().getY() + i).name == '_') {
                points.add(new ChessboardPoint(getSource().getX() + i, getSource().getY() + i));
            } else if (getSource().getX() + i < 8 && getSource().getY() + i < 8 && getConcreteChessGame().getChess(getSource().getX() + i, getSource().getY() + i).getChessColor() != getChessColor()) {
                points.add(new ChessboardPoint(getSource().getX() + i, getSource().getY() + i));
                break;
            } else {
                break;
        ...
        List<ChessboardPoint> points11 = new ArrayList<>();
        for (ChessboardPoint p : points) {
            if (points11.size() == 0) {
                points11.add(points.get(0));
            } else {
                int i = 0;
                while (i < points11.size() && (p.getX() > points11.get(i).getX() || (p.getX() == points11.get(i).getX() && p.getY() > points11.get(i).getY()))) {
                    i++;
                }
                points11.add(i, p);
            }
