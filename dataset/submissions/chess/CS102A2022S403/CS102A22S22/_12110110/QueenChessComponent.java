...
public class QueenChessComponent extends ChessComponent{
    ...
    public List<ChessboardPoint> canMoveTo() {
        ...
        for (int i=0; i<8; i++){
            for (int j=1; j <=7; j++) {
                int[] xx = {sourceX + j, sourceX + j, sourceX - j, sourceX - j, sourceX, sourceX, sourceX + j, sourceX - j};
                int[] yy = {sourceY + j, sourceY - j, sourceY + j, sourceY - j, sourceY + j, sourceY - j, sourceY, sourceY};
