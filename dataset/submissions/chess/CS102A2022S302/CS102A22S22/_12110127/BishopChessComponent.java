...
public class BishopChessComponent extends ChessComponent{
    ...
    final int maxSteps=8;final ArrayList<ChessboardPoint> moveDirection = directions.Slanting();
    public BishopChessComponent(ChessboardPoint chessboardPoint,ChessColor chessColor,char a){
