...
public class A6LocalTest {
    ...
    void test4() {
        ...
        assertTrue(canvas.addShape(0, 2, 'B', 3, 5, 1));
        assertFalse(canvas.addShape(0, 0, 'Z', 3, 5, 1));
        assertTrue(canvas.addShape(15, 12, 'C', 3, 5, 2));
        assertTrue(canvas.addShape(3, 6, 'D', 7, 12, 3));
    ...
    void test5() {
        ...
        assertEquals("""
                ...
                BBB         N      \s
                      ...
                      NNNNNNN      \s
                                   ...
                                   \s
                """, gridString(canvas.getCanvas()));
        assertEquals("[Circle: (1,1) area=4 pattern=M, RightTriangle: (0,2) area=11 pattern=B, RightTriangle: (15,12) area=11 pattern=C, RightTriangle: (6,6) area=51 pattern=N]", canvas.getShapesByArea().toString());
        ...
        assertEquals("[RightTriangle: (0,2) area=11 pattern=B, Circle: (1,1) area=4 pattern=M, RightTriangle: (6,6) area=51 pattern=N, RightTriangle: (15,12) area=11 pattern=C]", canvas.getShapesByLocation().toString());
    }
    ...
    void test8() {
        var canvas = new OverLapShapeCanvas(12, 16);
        assertTrue(canvas.addShape(4, 6, 'A', 1));
        assertFalse(canvas.addShape(10, 15, 'B', 18));
        assertFalse(canvas.addShape(15, 19, 'C', 4));
        assertFalse(canvas.addShape(0, 18, 'D', 12, 12, 2));
    ...
    void test9() {
        ...
        assertTrue(canvas.addShape(19, 15, 'C', 4));
        assertTrue(canvas.addShape(18, 0, 'D', 12, 12, 2));
        assertTrue(canvas.addShape(2, 2, 'E', 3, 5, 1));
        assertTrue(canvas.addShape(2, 2, 'F', 3, 5, 0));
        assertTrue(canvas.addShape(6, 6, 'G', 7, 12, 3));
        assertTrue(canvas.addShape(6, 6, 'H', 3, 5, 0));
...
//        assertFalse(canvas.addShape(18, 19, 'J', 5, 5, 3));
                  ...
                  EEEAHHHIIIII     \s
                    AAHHHIIIIII    \s
                      ...
                      GGGGGGG      C
                                   ...
                                   C
                """, gridString(canvas.getCanvas()));
        assertEquals("[Circle: (4,6) area=4 pattern=A, RightTriangle: (2,2) area=11 pattern=E, RightTriangle: (2,2) area=11 pattern=F, RightTriangle: (6,6) area=11 pattern=H, RightTriangle: (6,6) area=51 pattern=G, Circle: (19,15) area=60 pattern=C, RightTriangle: (18,0) area=78 pattern=D, Circle: (6,6) area=88 pattern=I]", canvas.getShapesByArea().toString());
        ...
        assertEquals("[RightTriangle: (2,2) area=11 pattern=E, RightTriangle: (2,2) area=11 pattern=F, Circle: (4,6) area=4 pattern=A, RightTriangle: (6,6) area=51 pattern=G, RightTriangle: (6,6) area=11 pattern=H, Circle: (6,6) area=88 pattern=I, RightTriangle: (18,0) area=78 pattern=D, Circle: (19,15) area=60 pattern=C]", canvas.getShapesByLocation().toString());
