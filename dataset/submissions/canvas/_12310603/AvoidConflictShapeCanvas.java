...
public class AvoidConflictShapeCanvas implements ShapeCanvas{
    ...
    public boolean addShape(int x, int y, char pattern, int... params) {
        ...
        if (params.length == 1) {
            ...
            this.x=x;
            this.y=y;
            if (x+2*params[0]>canves [0].length)
                return false;
            else if (y+2*params[0]>canves.length)
                return false;
            else if (this.ifaddcircle()){
                this.addcircle();
        ...
        if (params.length == 3) {
            ...
            if (y+params[0]>canves [0].length)
                return false;
            else if (x+params[1]>canves.length)
                return false;
            else if (this.ifaddTriangle()){
                this.addTriangle();
                Location p1 = new Location(x, y);
