        ...
        if(params.length==1){
            ...
            for (int i = x; i < canvas.length; i++) {
                for (int j = y; j < canvas[0].length; j++) {
                    if ((i-x)<2*params[0]&&(j-y)<2*params[0]&&circle.grids[i-x][j-y]!=' '){
                        canvas[i][j] = pattern;
                        flag = true;
                    }
                }
        ...
        if(params.length==3){
                switch (params[2]) {
                    case 0:
                        ...
                        for (int i = x; i < canvas.length; i++) {
                            for (int j = y; j < canvas[0].length; j++) {
                                if ((i-x)<params[1]&&(j-y)<params[0]&&rightTriangle0.grids[i-x][j-y]!=' '){
                                    canvas[i][j] = pattern;
                                    flag = true;
                                }
                            }
                    ...
                    case 1:
                        ...
                        for (int i = x; i < canvas.length; i++) {
                            for (int j = y; j < canvas[0].length; j++) {
                                if ((i-x)<params[1]&&(j-y)<params[0]&&rightTriangle1.grids[i-x][j-y]!=' '){
                                    canvas[i][j] = pattern;
                                    flag = true;
                                }
                            }
                    ...
                    case 2:
                        ...
                        for (int i = x; i < canvas.length; i++) {
                            for (int j = y; j < canvas[0].length; j++) {
                                if ((i-x)<params[1]&&(j-y)<params[0]&&rightTriangle2.grids[i-x][j-y]!=' '){
                                    canvas[i][j] = pattern;
                                    flag = true;
                                }
                            }
                    ...
                    case 3:
                        ...
                        for (int i = x; i < canvas.length; i++) {
                            for (int j = y; j < canvas[0].length; j++) {
                                if ((i-x)<params[1]&&(j-y)<params[0]&&rightTriangle3.grids[i-x][j-y]!=' '){
                                    canvas[i][j] = pattern;
                                    flag = true;
                                }
                            }
