    ...
    public boolean addShape(int x, int y, char pattern, int... params) {
        ...
        switch (params.length) {
            case 1:
                ...
                circle.fillGrids();
                if (x + circle.getGrids().length <= getCanvas().length && y + circle.getGrids()[0].length <= getCanvas()[0].length
                        &&ifConflict( location1.getX(), location1.getY(),circle.getGrids() )) {
            ...
            case 3:
                ...
                if (x + rightTriangle.getGrids().length <= getCanvas().length && y + rightTriangle.getGrids()[0].length <= getCanvas()[0].length
                        &&ifConflict( location2.getX(), location2.getY(),rightTriangle.getGrids() )) {
